...
What the last few years of pursuing my degree in computer science has taught me is that a degree is achievable to anyone, but to truly put forth the effort to understand what is being taught is far more rewarding. I have worked on many programs and faced many challenges along the way, but at each step of the way I put my all into my work and never gave up. Each of the projects I worked on taught me valuable information and insight into an industry that I am proud to call my career path. 
	
One of the most rewarding projects I had the chance to work on that taught me about the nature of source control and collaborating in a team environment when it comes to software development was a program that utilized eGit source control on bitbucket. I had the chance to work with many other collaborators on creating a Jukebox playlist application where we made commits, pushed our code, created pull requests, and peer reviewed each-others code before merging. This taught me how working together on a project utilizing many branches is very effective to the development cycle of software and how invaluable source control is for managing codebases to monitor the progress, assess problems and resolve conflicts in code.
	
I have had the chance to experience what it is like to develop in an agile development environment where I played the role of Scrum Master and helped maintain the schedule and make sure the team followed the order of flow and kept up communication on constant basis with not only the team, but also with the product owner and stakeholders. This taught me that it is important to have a high level of communication to be able to make changes during development so that the needs of the client can be met and assign tasks based on priority levels during sprints.
	
I have worked on multiple programs that utilize data structures and algorithms to search information for specific data using differing methods such as a binary search tree, sort data from external files using multiple different sorting methods, and even create hash tables. This taught me a lot about how useful certain algorithms can be and how data structures are important. Some of what can be achieved from these can be applied to many software solutions to provide much faster search results when searching through databases and help quickly sort through large amounts of data. I have also learned how to develop and navigate through databases, utilize them for client-server needs, and create websites that can link to databases. I learned about the importance of using software engineering and databases to develop efficient solutions to websites and servers for fast data retrieval and how these are used by many companies today.
	
One of the most important things I have learned is about security and how vulnerable most software is. I learned the differences in how Java handles inputs vs. C++ and how C++ needs to have a lot of code written to prevent those issues, and I also learned how to correct many common vulnerabilities such as buffer overflows and underflows, SQL injection attacks, and how to write encryption algorithms, handle exceptions, and even how to reverse engineer programs to identify where vulnerabilities lie. This was by far one of the most valuable skills that I have gained through pursuing my degree as not only does this allow me to effectively write code but do so with security in mind from start to finish.
	
Each of the artifacts in my ePortfolio reflect the skills that I have learned along the way and show how I utilize what I have learned to design and develop code using coding standard best practices and employ my learning to more effectively problem solve and face challenges through programming. I employed strategies for building collaborative environments that enable diverse audiences to support organizational decision making in the field of computer by completing the enhancements in my Thermostat Prototype, Vector Sorting program, and my Weight Tracking app by expanding on my comments in code and providing more in-depth explanation of what the code does allowing others to make changes to the design of the program as they see fit. I designed, developed, and delivered professional-quality oral, written, and visual communications that are coherent, technically sound, and appropriately adapted to specific audiences and contexts by the enhancements in my Thermostat Prototype where I provide a written explanation in my code comments that allows anyone to understand what the code is doing, and visual communication through my demonstration video where I explain the functionality of the device and provide a look into how it operates. I designed and evaluated computing solutions that solve a given problem using algorithmic principles and computer science practices and standards appropriate to its solution, while managing the trade-offs involved in design choices in my development of my Weight Tracking application where I solved the problems associated with the goal weight display through error tracking and debugging, assessed the problematic database and made the decision to remove certain features to ensure the program remained functional and easy to use for any type of user yet perform the required functionality with no error, and fixed the update functionality by tracking the error logs and identifying the solution to the problem using my resources and performing planned testing. I demonstrate an ability to use well founded and innovative techniques, skills, and tools in computing practices for the purpose of implementing computer solutions that deliver value and accomplish industry specific goals by incorporating my knowledge of software reverse engineering and how data moves on the stack to better program my Thermostat Prototype to handle input recognition using the most efficient methods available to me. I developed a security mindset that anticipates adversarial exploits in software architecture and designs to expose potential vulnerabilities, mitigate design flaws, and ensure privacy and enhanced security of data and resources by preventing inputs in my thermostat prototype from going above or below set temperature limits, by incorporating prevention of buffer overflow exploits in my vector sorting program through my use of clearing input buffers and checking for inputs going beyond stream limit maximums, by incorporation of default cases on each and every program to prevent unintended errors, and by my practice of performing testing on input handling for each of the applications in my ePortfolio.
...
- Fixed and properly implemented the update date/weight feature.
